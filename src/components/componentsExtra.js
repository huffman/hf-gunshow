...
createComponentType = function(name, client, server) {
...
createComponentType('attachment', {
}, {
    ctor: function(entityManager, properties) {
        var blueprintName = properties.blueprint;
        this.attachmentEntityID = spawnBlueprint(blueprintName, {
